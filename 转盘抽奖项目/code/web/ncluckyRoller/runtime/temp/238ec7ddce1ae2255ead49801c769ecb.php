<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:103:"/data/www/weixin.prykweb.com/weixintest/ncluckyRoller/public/../application/index/view/games/index.html";i:1572578641;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
	...
	<link href="https://weixin.prykweb.com/weixintest/ncxcxstatus/css/style2.css" rel="stylesheet">
	<script>
		(function (doc, win) {
...
<div class="bg">
	...
	<div class="rule">
		<div class="rutxt">
			<p class="mp2">活动规则：</p>
			<?php if($data['gameId'] == 15): ?>
			<p class="mp3">1. 活动期间每人只可参加1次抽奖，100%中奖；</p>
			<p class="mp3">2. <?php echo $data['contact']; ?>；</p>
...
<script type="text/javascript">
    ...
    window.onload=function(){
        ...
        $("#lottery a").click(function(){
            if (click) { //click控制一次抽奖过程中不能重复点击抽奖按钮，后面的点击不响应
                ...
                $.post("https://weixin.prykweb.com/weixintest/ncluckyRoller/public/getRes", {"userId":userId, "gameId":gameId},
                    function (result) {
    ...
    function commit(){
        $.ajax({
            type : "post",
            dataType : "json",
            url : "https://weixin.prykweb.com/weixintest/ncluckyRoller/public/commitInfo",
            data : {
                tel : $("#tel").val(),
                realname : $("#user").val(),
